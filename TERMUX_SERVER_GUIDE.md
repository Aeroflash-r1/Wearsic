...
curl -L -o ~/wearsic-server-termux.zip \
  "https://github.com/Aeroflash-r1/wearsic/releases/latest/download/wearsic-server-termux-v1.9.0.zip"
```
...
```json
{"status":"ok","version":"1.9.0","serverName":"Wearsic Engine","transcoderAvailable":true}
```
